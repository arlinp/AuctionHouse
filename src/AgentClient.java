...
public class AgentClient implements Runnable {
    ...
    private enum State {WAITING, SENT_KNOCK_KNOCK, SENT_CLUE, ANOTHER}


    private static String BYE = "Bye.";


    private static String[] clues = {"Turnip", "Little  Old  Lady", "Atch", "Who", "Who"};
    private static String[] answers = {"Turnip  the heat , it’s cold in here!", "I didn’t know  you  could  yodel!", "Bless  you!", "Is there  an owl in here?", "Is there  an echo in here?"};
